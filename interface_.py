...
class MercuryInterface(CodeInterface, GravitationalDynamicsInterface, GravityFieldInterface,
        CommonCodeInterface, LiteratureReferencesMixIn, StoppingConditionInterface):
    """
...
class MercuryWayWard(GravitationalDynamics, GravityFieldCode):
